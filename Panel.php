...
@media (max-width:768px) {
    ...
    .sidebar.show { left: 0; }
    .content-frame { padding-top: 50px; }
}
...
<div class="sidebar" id="sidebar">
    ...
    <div class="menu-search-box">
        <input type="text" id="menuSearchInput" placeholder="🔍 Buscar módulo o opción...">
    </div>
    ...
    <div class="accordion accordion-flush px-2" id="menuPrincipal">
        ...
        <div class="accordion-item">
            ...
            <div id="basico" class="accordion-collapse collapse show" data-bs-parent="#menuPrincipal">
...
function abrirPopup(event, url) {
    ...
    ventanaPopup = window.open(url, "CalculadoraPopup", opciones);
                    ...
                    <div class="menu-seccion ps-2">
                        ...
                        <a class="nav-link" href="ColaboradorFicha.php" target="contentFrame">👤 Ficha Demografica Colaborador</a>
                ...
                <div class="accordion-body">
                    <div class="accordion sub-accordion" id="adminSubAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="adminFin" class="accordion-collapse collapse" data-bs-parent="#adminSubAccordion">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="adminEstad" class="accordion-collapse collapse" data-bs-parent="#adminSubAccordion">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="adminNomina" class="accordion-collapse collapse" data-bs-parent="#adminSubAccordion">
                                <div class="accordion-body">
                                    <a class="nav-link" href="CrearColaborador.php" target="contentFrame">Crear Colaborador</a>
                                    <a class="nav-link" href="NominaGenerar.php" target="contentFrame">Liquidación Quincenal</a>
                                    <a class="nav-link" href="HistorialPagos.php" target="contentFrame">Historial Pagos</a>
